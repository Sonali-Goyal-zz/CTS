...
public class CTSStatsPanel extends JPanel {
     ...
     *  Constructor
     *
     *  ctsP an object of the main controller class
     *  st The Stats.
     */
	 ...
	 * 	Adds a Label.
	 *
         *  label The lable to add.
         *  s The text of the string
         *  backColor The Background Color.
         *  fontColor The Color of the Fonts.
         *  grdx The value of the gridx.
         *  grdy The value of the gridy
         *  prefx The x value of the dimension of this label.
         *  prefy The y value of the dimension of this label.
	 *
	 */
